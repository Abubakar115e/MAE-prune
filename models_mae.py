...
try:
    ...
    from torch.utils.model_zoo import load_url as load_state_dict_from_urlfrom timm.data 
import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
class VisionTransformer(timm.models.vision_transformer.VisionTransformer):
    ...
    """
    def __init__(self, global_pool=True, pretrained_cfg=None, **kwargs):
